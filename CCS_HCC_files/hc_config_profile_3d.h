...
% Azimuth Angle (deg): -30 + 30
% Range Resolution(m):0.044
% Maximum unambiguous Range(m):18.02
% FPS 30
% Grouping in range direction
% ***************************************************************
sensorStop
flushCfg
dfeDataOutputMode 1
...
adcCfg 2 1
adcbufCfg -1 0 1 1 1
profileCfg 0 60 287 7 57.14 0 0 70 1 496 10093 0 0 158
...
#define PROFILE_HCC_0_IDLE_TIME_VAL         (287U)
#define PROFILE_HCC_0_ADC_START_TIME_VAL    (7U)
#define PROFILE_HCC_0_RAMP_END_TIME_VAL     (57.14f)
#define PROFILE_HCC_0_TXOUT_POWER_BACKOFF   (0U)
#define PROFILE_HCC_0_TXPHASESHIFTER_VAL    (0U)
#define PROFILE_HCC_0_FREQ_SLOPE_MHZ_PER_US (70U)
#define PROFILE_HCC_0_TX_START_TIME_VAL     (1U)
#define PROFILE_HCC_0_ADC_SAMPLE_VAL        (496U)
#define PROFILE_HCC_0_DIGOUT_SAMPLERATE_VAL (10093U)
#define PROFILE_HCC_0_HPFCORNER_FREQ1_VAL   (0U)
#define PROFILE_HCC_0_HPFCORNER_FREQ2_VAL   (0U)
#define PROFILE_HCC_0_RX_GAIN_VAL           (158U)
...
#define CHIRP_HCC_1_TX_CHANNEL              (2U)
...
#define CHIRP_HCC_2_TX_CHANNEL              (4U)
...
#define FRAME_HCC_NUM_LOOPS                 (16U)
#define FRAME_HCC_NUM_FRAMES                (0U)
#define FRAME_HCC_FRAME_PERIODICITY         (33.333f)
...
#define GUI_HCC_0_LOG_MAGNITUDE_RANGE       (0U)
#define GUI_HCC_0_NOISE_PROFILE             (0U)
#define GUI_HCC_0_RANGE_AZIMUTH_MAP         (0U)
#define GUI_HCC_0_RANGE_DOPPLER_MAP         (0U)
#define GUI_HCC_0_STATS_INFO                (0U)
...
#define CFAR_HCC_0_PEAK_GROUPING            (1U)
...
#define CFAR_HCC_1_PEAK_GROUPING            (1U)
...
#define CFAR_FOV_HCC_0_MINIMUM              (0.0f)
#define CFAR_FOV_HCC_0_MAXIMUM              (17.30f)

#define CFAR_FOV_HCC_1_SUBFRAME_IDX         (-1)
#define CFAR_FOV_HCC_1_PROC_DIRECTION       (1U)
#define CFAR_FOV_HCC_1_MINIMUM              (-1.21f)
#define CFAR_FOV_HCC_1_MAXIMUM              (1.21f)

#define MEASURERANGEBIAS_HCC_ENABLED        (0U)
#define MEASURERANGEBIAS_HCC_TARGET_DIST    (1.5f)
#define MEASURERANGEBIAS_HCC_SEARCH_WIN     (0.2f)

#define CQRXSAT_HCC_0_PROFILE_ID            (0U)
#define CQRXSAT_HCC_0_SAT_MON_SEL           (3U)
#define CQRXSAT_HCC_0_PRI_SLICE_DURATION    (5U)
#define CQRXSAT_HCC_0_NUM_SLICES            (121U)
#define CQRXSAT_HCC_0_RX_CHAN_MASK          (0U)

#define CQSIGIMG_HCC_0_PROFILE_ID           (0U)
#define CQSIGIMG_HCC_0_NUM_SLICES           (123U)
#define CQSIGIMG_HCC_0_NUM_SAMPLE_PER_SLICE (8U)
